...
public class ToolTip {
    ...
    public int mWidth;
    public GRAVITY_TYPE mGravityType = GRAVITY_TYPE.SCREEN;
...
//    }
    ...
    public ToolTip setLayoutParam(FrameLayout.LayoutParams params) {
        this.mLayoutParams = params;
        return this;
    }

    public ToolTip setGravityType(GRAVITY_TYPE gravityType) {
